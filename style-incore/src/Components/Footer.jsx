      ...
      <Container as={Stack} maxW={"6xl"} py={10} width="100%">
        ...
        >
          <Stack spacing={4} alignItems="center">
            ...
            <Stack align={"start"} alignItems="center" mr={"10px"}>
          ...
          <Stack align={"flex-start"}>
            ...
            <Text fontSize={"sm"} href={"#"}>
              Express Marketplace FAQ
            </Text>
            <Text fontSize={"sm"} href={"#"}>
              Klarna Payments
            </Text>
            <Text fontSize={"sm"} href={"#"}>
              Google Ad Price Policy
            </Text>
          </Stack>
        </SimpleGrid>
        ...
        <Stack>
          <Text fontWeight={500}>
            Terms & Conditions | Accessibility | About Ads | Privacy Policy | Do
            Not Sell | My Personal Information | Site Map | © 2023 Express. All
            rights reserved.
          </Text>
        </Stack>
      </Container>
